public class UpRaise{
    void salaryUpraise(Employee employee){
        ...
        float appraisedSalary = (float) (employee.salary + bonus);
        System.out.println("Bonus: "+ bonus);
        System.out.println("Appraised Salary: " + appraisedSalary);
    }
    ...
    void salaryUpraiseByType(Employee employee){
        if(employee instanceof PermanentEmployee){
            ...
            {
                float increasedRate = (float) (0.1 * ((ContractEmployee)employee).hourlyWage) + ((ContractEmployee)employee).hourlyWage;
